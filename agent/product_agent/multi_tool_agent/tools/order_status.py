...
class OrderStatusTool(BaseAPITool):
    ...
    def get_order_status(
        ...
        - Sản phẩm:
          1. Tên sản phẩm - Giá: XX,XXX VND - Số lượng: X - Id: <a href="http://localhost:4202/product/{product_id}">XXXX</a>
          2. Tên sản phẩm - Giá: XX,XXX VND - Số lượng: X - Id: <a href="http://localhost:4202/product/{product_id}">XXXX</a>
